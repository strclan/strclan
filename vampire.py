...
TELEGRAM_BOT_TOKEN = '7587150435:AAHtF5qcVpBAY4cjeaTDNPxVZ3hDv_P3P5s'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
       "*🚀ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ıllıllı ƔαɱקIııƦǝ ɱσ∂ χ DɗoS̴ S̴ǝƦƔǝƦ ıllıllı 🚀*\n\n"
        ...
        "*💀ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @STR_ANSHU_OG 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @STR_ANSHU_OG💥*"
    ), parse_mode='Markdown')
